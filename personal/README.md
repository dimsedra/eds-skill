...
Personal use-case skills for Eds: skills that serve specific personal workflows, not universal audiences.

Personal skills follow the same structure as the other skills (a folder with a `SKILL.md`), but they can be more specific: they exist for one user's recurring needs, so the "universal context" rule loosens here.
